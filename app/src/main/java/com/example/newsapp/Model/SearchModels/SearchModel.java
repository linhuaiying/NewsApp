package com.example.newsapp.Model.SearchModels;
...
public class SearchModel {
    String keyWords;
    public SearchModel(String keyWords) {
        this.keyWords = keyWords;
    }
    public void loadSearchNewsData(SearchModel.OnLoadListener onLoadListener) throws InterruptedException {
    ...
    public List<UsersNews> getData() throws InterruptedException {
        ...
        Call<List<UsersNews>> call = usersNewsService.getSearchNewsList(keyWords);
